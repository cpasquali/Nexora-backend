...
Notifications.belongsTo(User, { foreignKey: "actor_id", as: "actor" });
User.hasMany(Notifications, { foreignKey: "user_id", as: "notification" });

export { User, Post, Comment, PostLikes, Notifications };
